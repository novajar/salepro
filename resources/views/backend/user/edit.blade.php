                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="biller-id">
                                        ...
                                        <!-- <select name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Biller...">
                                          @foreach($lims_biller_list as $biller)
                                              <option value="{{$biller->id}}" {{ $biller->id == 1 ? 'selected' : '' }}>{{$biller->name}}</option>
                                          @endforeach
                                        </select> -->
                                        <input type="hidden" name="biller_id" value="{{$lims_user_data->biller_id}}">
                                    ...
                                    <div class="form-group" id="warehouseId">
                                        ...
                                        <input type="hidden" name="warehouse_id" value="{{$lims_user_data->warehouse_id}}">
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
