                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="warehouse_id" id="warehouse_id" value="1" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Biller...">
                                                @foreach($lims_user_list as $biller)
                                                <option value="{{$biller->id}}" {{ $biller->id == $userId ? 'selected' : '' }}>{{$biller->name}}</option>
                                                @endforeach
                                            </select> -->
                                            
                                            <input type="hidden" name="biller_id" id="biller_id" value="1" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                    ...
                    <form>
                        <div class="row modal-element">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="number" step="any" name="edit_qty" class="form-control numkey" readonly>
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <?php if(json_encode(Auth::user()->role_id) > 2){
                                    $readonly =  "readonly";
                                }else{
                                    $readonly="";
                                }?>
                                <input type="number" name="edit_unit_price" class="form-control numkey" step="any" <?php echo $readonly;?>>
                            </div>
                            <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
                            ...
                            <div id="edit_unit" class="col-md-4 form-group">
                                ...
                                <select name="edit_unit" class="form-control selectpicker" onchange="tester()">
                                </select>
                            </div>
                        </div>
...
$('button[name="update_btn"]').on("click", function() {
    ...
    if(product_type[pos] == 'standard') {
        ...
        // alert(position);
        var unit_type_text = $('select[name="edit_unit"] option:selected').text();
        $('.unit_type').text(unit_type_text);
    }
    else {
        product_price[rowindex] = $('input[name="edit_unit_price"]').val();
    }
...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit_price').text(row_product_price.toFixed(0));
